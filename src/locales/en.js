export default {
  ...
  projects: {
    ...
    landing_page: {
      title: "Landing Page — Technology Agency (Creative Project)",
    ...
    doggys: {
      title: "Inventory System — Doggy's Store",
    ...
    software: {
      title: "Maintenance Management App — University Project (Software Engineering)",
    ...
    plaf: {
      title: "Custom Legal Suite — Tailored Solution for Lawyers",
  ...
  bad_words_detected: "⚠️ Please avoid using offensive language. This space is intended for respectful and professional communication.",
  thanks_title: "Thanks a lot 🙌",
  thanks_text: "Thank you very much for writing to me and considering me for your next project and collaboration. I will be in touch with you shortly. 👍",
